...
Report bugs at https://github.com/into-ai/kerasltisubmission/issues.
...
kerasltisubmission could always use more documentation, whether as part of the
official kerasltisubmission docs, in docstrings, or even on the web in blog posts,
articles, and such.

Submit Feedback
~~~~~~~~~~~~~~~

The best way to send feedback is to `file an issue <https://github.com/into-ai/kerasltisubmission/issues>`_ on GitHub.
...
Ready to contribute? Here's how to set up kerasltisubmission for local development.

1. Fork the `kerasltisubmission repo <https://github.com/into-ai/kerasltisubmission>`_ on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/kerasltisubmission.git

3. Install development dependencies into a virtual development environment (assuming you have ``pipenv`` installed)::

    $ cd kerasltisubmission/
    $ pipenv install --dev
...
3. The pull request should work for python 3.5+. Check the
   `build status of your pull request <https://travis-ci.com/into-ai/kerasltisubmission/pull_requests>`_
...
.. _GitHub issues: https://github.com/into-ai/kerasltisubmission/issues
